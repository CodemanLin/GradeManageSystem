            ...
            <section class="wrapper">
                <div class="table-agile-info">
                    <div class="panel panel-default">
                        ...
                        <div>
                            <form action="admin_cxcjkh.php" method="post">
                                <label>
                                    请输入课号查询<input type="text"   name="course_id"   required="required">
                            ...
                            <table class="table" ui-jq="footable" ui-options='{
                                ...
                                <tbody>
                                    ...
                                    if($courseid){
                                     $sql="select * from course where course_id='$courseid' and course_id in(select course_id from grade where flag='2')";   
                                    }else{
                                    $sql = "select * from course where  course_id in(select course_id from grade where flag='2')";
                                    }
                                    ...
                                    while ($arr = mysqli_fetch_assoc($res)) {
                                        ...
                                        echo "<td><a href='admin_ckcj.php?flag=" .$arr['course_id'] . "'>查看</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                </tbody>
