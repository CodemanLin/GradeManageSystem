                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="position-center">
                                    <form role="form" action="admin_instu1.php" method="post">
                                        <div class="form-group">
                                            <label for="exampleInputText1">学号</label>
                                            <input type="text" class="form-control" id="exampleInputEmail1" name="stuno"
                                                   required="required">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span><input type="radio" name="sex" value="男"/>男&emsp;&emsp;
                                        ...
                                        <button type="submit" class="btn btn-info">添加学生</button>&emsp;&emsp;
