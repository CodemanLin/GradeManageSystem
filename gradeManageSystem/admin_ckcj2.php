    ...
    <section id="container">
        ...
        <section id="main-content">
         ...
         <?php
			...
			$sql_cj = "select * from grade where stuno='$A' and course_id='".$arr['course_id']."'";
             $r=mysqli_query($conn,$sql_cj);
            
			//$rpm = mysqli_fetch_array($conn,$q_pm);
        ...
        ?>
                            ...
                            <a href="admin_cxcj2dc.php?flag=<?php echo $_GET['flag'];   ?>" style="float:right;font-size:16px">打印学生成绩</a>
                        </div>
                    </div>
                </div>
            </section>
