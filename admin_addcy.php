...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="form-w3layouts"><!--表单框样式-->
                <!-- page start-->
                <div class="row">
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading"><!--表单头部样式-->
                                添加课程:单个添加
                            </header>
                            <div class="panel-body">
                                <div class="position-center">
                                    <form role="form" action="admin_incou1.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputText1">平时比例</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1"
                                                   name="blps">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputText1">考试比例</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1"
                                                   name="blks">
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="teach_id" class="form-control">
                                                ...
                                                while ($arr = mysqli_fetch_array($res)) {
                                                    echo "<option value='" . $arr['teach_id'] . "'>" . $arr['name'] . "</option>";
                                                }

                                                ?>
                                            </select>
                                        </div>
                                        <button type="submit" class="btn btn-info">添加课程</button>&emsp;&emsp;
