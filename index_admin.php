...
<head>
    ...
    <link rel="stylesheet" href="css/font-awesome.css" type="text/css" ><!--选项小图标--> 
        ...
        <aside><!--侧边栏样式-->
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion"><!--侧边栏字体样式-->
                        <li>
        ...
        <section id="main-content">
            <section class="wrapper">
                    ...
                    <div class="col-md-6 w3agile-notifications">
                        <div class="notifications"><!--管理员首页表单样式-->
                            <!--notification start-->
                                ...
                                <div>
                                    <table class="table" ui-jq="footable" ui-options='{
                                        ...
                                        <tbody>
                                            ...
                                            $sql1 = "select course_id,count(*) as ycjnum from grade where flag='1' group by course_id";
                                            ...
                                            while ($arr = mysqli_fetch_assoc($res)) {
                                                ...
                                                echo "<td>" . $xknum. "</td>";
                                                echo "<td><a href='admin_dsure.php?flag=".$arr['course_id']."'>查看确认</a></td>";
                                                echo "</tr>";
                                            }
                                            ?>
